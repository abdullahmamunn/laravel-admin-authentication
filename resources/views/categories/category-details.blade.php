            ...
            <div class="col-md-9 single-box">
                ...
                <div class=" buying-top">
                    <div class="flexslider">
                        <ul class="slides">
                            <li data-thumb="{{asset('front-end/images/ss.jpg')}}">
                                <img src="{{asset('front-end/images/ss.jpg')}}" />
                            </li>
                            <li data-thumb="{{asset('front-end/images/ss1.jpg')}}">
                                <img src="{{asset('front-end/images/ss1.jpg')}}" />
                            </li>
                            <li data-thumb="{{asset('front-end/images/ss2.jpg')}}">
                                <img src="{{asset('front-end/images/ss2.jpg')}}" />
                            </li>
                            <li data-thumb="{{asset('front-end/images/ss3.jpg')}}">
                                <img src="{{asset('front-end/images/ss3.jpg')}}" />
                            </li>
                        </ul>
                    </div>
                    <!-- FlexSlider -->
                ...
                <div class="buy-sin-single">
                    <div class="col-sm-5 middle-side immediate">
                        ...
                        <div class="   right-side">
                            <a href="{{route('contact')}}" class="hvr-sweep-to-right more" >Contact Builder</a>
                        </div>
                    </div>
            ...
            <div class="col-md-3">
                <div class="single-box-right right-immediate">
                    ...
                    <div class="single-box-img ">
                        <div class="box-img">
                            <a href="single.html"><img class="img-responsive" src="{{asset('front-end/images/sl.jpg')}}" alt=""></a>
                        </div>
                        <div class="box-text">
                    ...
                    <div class="single-box-img">
                        <div class="box-img">
                            <a href="single.html"><img class="img-responsive" src="{{asset('front-end/images/sl1.jpg')}}" alt=""></a>
                        </div>
                        <div class="box-text">
                            <p><a href="single.html">Lorem ipsum dolor sit amet</a></p>
                            <a href="single.html" class="in-box">More Info</a>
                    ...
                    <div class="single-box-img">
                        <div class="box-img">
                            <a href="single.html"><img class="img-responsive" src="{{asset('front-end/images/sl2.jpg')}}" alt=""></a>
                        </div>
                        <div class="box-text">
                            <p><a href="single.html">Lorem ipsum dolor sit amet</a></p>
                            <a href="single.html" class="in-box">More Info</a>
                    ...
                    <div class="single-box-img">
                        <div class="box-img">
                            <a href="single.html"><img class="img-responsive" src="{{asset('front-end/images/sl3.jpg')}}" alt=""></a>
                        </div>
                        <div class="box-text">
                            <p><a href="single.html">Lorem ipsum dolor sit amet</a></p>
                            <a href="single.html" class="in-box">More Info</a>
                    ...
                    <div class="single-box-img">
                        <div class="box-img">
                            <a href="single.html"><img class="img-responsive" src="{{asset('front-end/images/sl4.jpg')}}" alt=""></a>
                        </div>
                        <div class="box-text">
                            <p><a href="single.html">Lorem ipsum dolor sit amet</a></p>
                            <a href="single.html" class="in-box">More Info</a>
            ...
            <div class="content-bottom-in">
                <ul id="flexiselDemo1">
                    <li><div class="project-fur">
                            <a href="single.html" ><img class="img-responsive" src="{{asset('front-end/images/pi.jpg')}}" alt="" />	</a>
                            <div class="fur">
                                <div class="fur1">
                    ...
                    <li><div class="project-fur">
                            <a href="single.html" ><img class="img-responsive" src="{{asset('front-end/images/pi1.jpg')}}" alt="" />	</a>
                            <div class="fur">
                                <div class="fur1">
                                    <span class="fur-money">$2.44 Lacs - 5.28 Lacs </span>
                                    <h6 class="fur-name"><a href="single.html">Contrary to popular</a></h6>
                    ...
                    <li><div class="project-fur">
                            <a href="single.html" ><img class="img-responsive" src="{{asset('front-end/images/pi2.jpg')}}" alt="" />	</a>
                            <div class="fur">
                                <div class="fur1">
                                    <span class="fur-money">$2.44 Lacs - 5.28 Lacs </span>
                                    <h6 class="fur-name"><a href="single.html">Contrary to popular</a></h6>
                    ...
                    <li><div class="project-fur">
                            <a href="single.html" ><img class="img-responsive" src="{{asset('front-end/images/pi3.jpg')}}" alt="" />	</a>
                            <div class="fur">
                                <div class="fur1">
                                    <span class="fur-money">$2.44 Lacs - 5.28 Lacs </span>
                                    <h6 class="fur-name"><a href="single.html">Contrary to popular</a></h6>
